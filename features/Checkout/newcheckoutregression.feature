...
|prodid|firstname|lasttname|addressline1|addressline2|city|state|zipcode|phonenumberareacode|phonenumberexchangeNbr|phonenumbersubscriberNbr|errormessage|
|125450|QA|Macys|685 |Montgomery|San Fransisco|Armed Forces Europe|09003|123|456|7890|There are shipping restrictions on items in your bag. These items can not be shipped to the shipping address provided. Please remove from your bag to continue.|
...
|667111|QA|Macys|685 Market Street|Montgomery|San Francisco|California|94538|123|456|7890|This item is unavailable|Your shopping bag is empty|
...
Then I should see the Payment page
	...
	And I enter contact phonenumber areacode "<phonenumberareacode>"
	And I enter contact phonenumber exchangeNbr "<phonenumberexchangeNbr>"
	And I enter contact phonenumber subscriberNbr "<phonenumbersubscriberNbr>"
...
|1310|QA|Macys|685 Market Street|Montgomery|San Fransisco|California|94538|123|456|7890|Visa|4111111111|July|2013|111|qa@gmail.com|123|456|7890|Please enter a valid credit card number.|
...
|1310|QA|Macys|685 Market Street|Montgomery|San Fransisco|California|94538|123|456|7890|Visa|4111111111111111|June|2013|111|qa@gmail.com|123|456|7890|qa@yahoo.com|qa@yahoo.com|12345|12345|December|30|1999|You must be at least 13 years old to register with macys.com.|
...
Then I should see shopping bag is empty with message "<expectedMessage>"

Examples:  Shipping & Billing Information Test Data
|prodid|firstname|lasttname|addressline1|addressline2|city|state|zipcode|phonenumberareacode|phonenumberexchangeNbr|phonenumbersubscriberNbr|cardtype|cardnumber|expmonth|expyear|securitycode|contactemailaddress|phonenumberareacode|phonenumberexchangeNbr|phonenumbersubscriberNbr|expectedMessage|
...
When I navigate to shopping bag page from PDP
Then I am on the your shopping bag page
When I continue checkout on your shopping bag page
Then I should see the Shipping page
