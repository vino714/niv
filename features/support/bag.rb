...
# Contents : This file holds the shopping bag class.
# Description : "Bag" class contains all required methods to read product details and add to hash 
# Also i provides methods to read verfiy the 'Checkout' page 
...
class Bag
  ...
  @xpath_product_quantity = "//select[@id='productQuantity']" 
